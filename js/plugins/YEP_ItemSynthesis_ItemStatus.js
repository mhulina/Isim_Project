...
Window_SynthesisList.prototype.initialize = function(commandWindow, statusWindow) {
...
Scene_Synthesis.prototype.createListWindow = function() {
    this._listWindow = new Window_SynthesisList(this._commandWindow, this._itemstatusWindow);
    this._listWindow.setHandler('ok', this.onListOk.bind(this));
    this._listWindow.setHandler('cancel', this.onListCancel.bind(this));
    this._listWindow.setHelpWindow(this._helpWindow);
    this._itemstatusWindow.x = this._listWindow.width;
    this._itemstatusWindow.width = Graphics.boxWidth - this._listWindow.width;
...
Scene_Synthesis.prototype.createItemStatusWindow = function() {
	var wx = 0;
	var wy = Graphics.boxHeight - this._helpWindow.height - 182;
    this._itemstatusWindow = new Window_ItemStatus(wx, wy);
    this.addWindow(this._itemstatusWindow);
	
Window_ItemStatus.prototype.setInfoWindow = function(infoWindow) {
